            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="tlp_staff" id="tlp_staff" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email_staff" id="email_staff" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <select name="prodi_prodi_id" id="prodi_prodi_id" class="custom-select">
                            ...
                            <?php foreach($prodi as $prd): ?>
                                <option value="<?= $prd->prodi_id ?>"><?= $prd->namaprod ?></option>
                            <?php endforeach;?>
                        </select>                        
                    </div>
