...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark font-weight-bold">Edit Data Jenis Barang</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="id_jenis" class="form-control" id="id_jenis" value="<?= $jenisbarang->id_jenis ?>" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_jenis" class="form-control" id="nama_jenis" value="<?= $jenisbarang->nama_jenis ?>">
