    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?=base_url('dashboard')?>assets/index2.html" class="logo">
                <span class="logo-mini">T<b>I<b>K</b></b></span>
                <span class="logo-lg">TIK<b>Laboratorium</b></span>
            </a>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="<?=site_url('dashboard')?>"><i class="fa fa-dashboard"></i> <span>Data Barang</span></a>
                    </li>
                    <li>
                        <a href=""><i class="fa fa-truck"></i> <span>Tambah Data Barang</span></a>
                    </li>
                    <li>
                        <a href="">
                            <i class="fa fa-users"></i> <span>Peminjaman Barang</span>
                        </a>
                    </li>
                    <li>
                        <a href="">
                            <i class="fa fa-users"></i> <span>Supplier Barang</span>
                        </a>
                    </li>
                    <li class="treeview">
                        <a href="#">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2020 <a href="">TIK PNJ</a>.</strong> All rights reserved.
        </footer>
